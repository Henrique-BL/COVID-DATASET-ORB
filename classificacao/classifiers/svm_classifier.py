...
def main():
    featureName = 'orb'
    trainFeaturePath = f'classificacao/features_labels/{featureName}/train/'
    testFeaturePath = f'classificacao//features_labels/{featureName}/test/'
...
def plotConfusionMatrix(encoderClasses,testEncodedLabels,predictedLabels,featureName):
    ...
    plt.savefig('classificacao/results/'+featureName+'-'+getCurrentFileNameAndDateTime(), dpi=300)  
